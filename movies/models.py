...
class Movie(models.Model):
    ...
    tagline = models.CharField('Слагон', max_length=100, default='')
    description = models.TextField("Описание")
    ...
    fees_in_usa = models.PositiveIntegerField('Сбора в США', default=0, help_text='указывать сумму в долларах')
...
class MovieShots(models.Model):
    ...
    description = models.TextField("Описание")
    image = models.ImageField('Постер', upload_to='movie_shots/')
